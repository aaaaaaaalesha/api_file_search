...
- сервер осуществляет поиск только внутри определённой директории, **которая задаётся в переменной окружения
  ** `SEARCH_DIR`.
...
**❗ВАЖНО❗** В проекте используется аннотирование типов, доступное с **Python 3.10** и выше.
